...
const StoryBox = ({ data }) => {
  return (
    <div className="rounded-md h-48 md:h-60 lg:h-80 relative">
      ...
      <div className="bg-white absolute bottom-2 left-6 md:left-14 lg:left-[72px] rounded-2xl flex font-semibold items-center gap-1 px-2 py-[2px] text-sm text-zinc-600">
        <IoPlay />
